...
public class GenericEntityDao<T extends IBaseEntity> {
    ...
    public Optional<T> getById(Class<T> classT, Long id) {
        SessionFactory factory = HibernateUtil.getSessionFactory();
        try (Session session = factory.openSession()) {
    ...
    // delete
    public void delete(Class<T> classT, Long id) {
    ...
    public void deleteMyObject(T entity) {
        SessionFactory factory = HibernateUtil.getSessionFactory();
        try (Session session = factory.openSession()) {
